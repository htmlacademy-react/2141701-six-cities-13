...
export const setLoadingData = (state: RootState): boolean => state[NameSpace.Offers].isLoadingData;
export const setErrorLoading = (state: RootState): boolean => state[NameSpace.Offers].hasError;
